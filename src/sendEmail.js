...
module.exports = async(req, res) => {
    ...
    const mailOptions = {
        ...
        html: `<p>Dear ${appeal.user},<br><br>${html}<br><br>Sincerely,<br>${interaction.member.user.username}#${interaction.member.user.discriminator}</p>`
    };
    ...
    await appeals.findOneAndDelete({id: data.id})
}